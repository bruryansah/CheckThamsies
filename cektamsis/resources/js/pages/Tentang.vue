            ...
            <div class="navbar-container">
                <div class="navbar-brand">
                    <img src="https://smktamansiswa2jakarta.sch.id/wp-content/uploads/2022/03/LOGO-TAMSIS-MATERIAL-DESIGN.png"
                        alt="SMK Tamansiswa 2 Logo" class="brand-logo" />
                ...
                <div class="nav-menu" :class="{ 'mobile-open': isMobileMenuOpen }">
                    <Link href="/" :class="['nav-link', { active: activeMenu === 'beranda' }]"
                        @click="setActiveMenu('beranda')">
                    <span class="nav-icon">🏠</span>
                    <span>Beranda</span>
                    </Link>
                    <Link href="/tentang" :class="['nav-link', { active: activeMenu === 'tentang' }]"
                        @click="setActiveMenu('tentang')">
                    <span class="nav-icon">📋</span>
                    <span>Tentang</span>
                    </Link>
                    <Link href="/kontak" :class="['nav-link', { active: activeMenu === 'kontak' }]"
                        @click="setActiveMenu('kontak')">
                    <span class="nav-icon">📞</span>
                    <span>Kontak</span>
                    </Link>
                </div>
        ...
        <main class="main-content">
            ...
            <section class="page-header animate-on-scroll">
                <div class="header-container">
                    ...
                    <p class="page-description">Digitalisasi absensi siswa dengan QR Code dan GPS untuk manajemen
                        kehadiran yang lebih cerdas.</p>
                </div>
            </section>
                    ...
                    <div class="vm-grid">
                        <div class="vision-card">
                            ...
                            <p class="vm-description">
                                Menjadi sistem absensi digital terdepan yang mendukung transformasi pendidikan menuju
                                era digital dengan teknologi
                                yang mudah digunakan, akurat, dan terpercaya untuk menciptakan lingkungan belajar yang
            ...
            <section class="majors-section animate-on-scroll">
                <div class="section-container">
                    ...
                    <div class="majors-grid">
                        <div v-for="(major, index) in majors" :key="index"
                            :class="`major-card delay-${index % 3}`">
                ...
                <div class="cta-container">
                    <div class="cta-content">
                        ...
                        <p class="cta-description">
                            Tim support kami siap membantu menjawab pertanyaan Anda tentang sistem absensi digital dan
        ...
        <footer class="footer">
            <div class="footer-container">
                <div class="footer-brand">
                    <img src="https://smktamansiswa2jakarta.sch.id/wp-content/uploads/2022/03/LOGO-TAMSIS-MATERIAL-DESIGN.png"
                        alt="SMK Tamansiswa 2" class="footer-logo" />
                    <div class="footer-info">
                        <div class="footer-title">SMK Tamansiswa 2 Jakarta</div>
                        <a href="https://smktamansiswa2jakarta.sch.id" target="_blank" class="footer-link">
                            smktamansiswa2jakarta.sch.id </a>
                    </div>
                </div>
                <div class="footer-socials">
                    ...
                    <a href="https://youtube.com/@smktamansiswa2jakarta375?si=XuMQeADTidosYWLq" class="social-btn"
                        target="_blank">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round" class="social-icon">
