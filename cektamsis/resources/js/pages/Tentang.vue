...
const stats = ref([
    { number: '1,247', label: 'Total Siswa', icon: '👥', color: 'from-blue-500 to-cyan-500' },
    { number: '87', label: 'Guru Profesional', icon: '👨‍🏫', color: 'from-green-500 to-emerald-500' },
    { number: '36', label: 'Ruang Kelas', icon: '🏫', color: 'from-purple-500 to-pink-500' },
    { number: '6', label: 'Program Keahlian', icon: '📚', color: 'from-orange-500 to-red-500' },
]);
            ...
            <section class="stats-section animate-on-scroll">
                <div class="stats-container">
                    <div class="stats-grid">
                        <div v-for="(stat, index) in stats" :key="index" :class="`stat-card delay-${index}`">
