    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-6 overflow-x-auto p-6">
            <div class="mx-auto w-full max-w-2xl rounded-2xl border border-zinc-800 bg-zinc-900 p-6 shadow-lg">
                ...
                <!-- Form -->
                <form @submit.prevent="form.post('/siswax/tambahstore')" class="space-y-5">
                    <!-- Pilih User -->
                    <div>
                    ...
                    <div>
                        ...
                        >
                            ...
                            <option v-for="k in props.kelas.filter((k) => /^X\s/.test(k.nama_kelas))" :key="k.id_kelas" :value="k.id_kelas">
                                {{ k.nama_kelas }}
                            </option>
                        </select>
                    ...
                    <div class="flex justify-end gap-3">
                        <Link href="/siswax" class="rounded-lg bg-zinc-700 px-4 py-2 text-sm font-semibold text-white hover:bg-zinc-600">
                            Batal
                        </Link>
                        <button
                            type="submit"
